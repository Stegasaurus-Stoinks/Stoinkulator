...
class Algo(ParentAlgo):
    def __init__(self, algoConfigData):
        ...
        self.FrontEndDataStruct = ['FinishedWaves','currentWave','StopPrice',"Trade"]
        self.FrontEndDataType = ['segment','segment','segment','baseline']
    ...
    def update(self, StockData):
        ...
        # self.finishedWaves,self.tradingWaves = Elliotfuncs.elliotRecursiveBlast(StockData,self.ticker.dataSize,self.order)
        if self.inTrade:
            print("In a trade")
